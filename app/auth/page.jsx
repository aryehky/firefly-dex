...
const Auth = () => {
    ...
    return (
        <div className="flex flex-col items-center min-h-[80vh] w-full px-4 md:px-0 font-pixel bg-skyblue">
            <div className="w-full max-w-md mt-16 mb-8 bg-white border-2 border-deepblue rounded-pixel shadow-pixel p-8 flex flex-col items-center">
                ...
                {error && <div className="bg-coral text-white p-2 rounded-pixel mb-4 w-full text-center">{error}</div>}
                ...
                <div className="w-full flex flex-col gap-4">
                    {step === 0 && (
                        <button
                            ...
                            className="font-pixel bg-coral text-white border-2 border-deepblue rounded-pixel px-6 py-3 shadow-pixel hover:scale-105 transition-transform text-lg"
                        >
