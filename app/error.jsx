...
export default function Error({ error, reset }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] font-pixel text-deepblue">
      ...
      <button onClick={reset} className="bg-coral text-cloud border-2 border-deepblue rounded-pixel px-6 py-2 shadow-pixel hover:scale-105 transition-transform text-lg">Try Again</button>
    </div>
  );
} 